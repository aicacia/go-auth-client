...
func NewVersion(build time.Time, version string) *Version {
	this := Version{}
	this.Build = build
...
func (o *Version) GetBuild() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *Version) GetBuildOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Build, true
...
func (o *Version) SetBuild(v time.Time) {
	o.Build = v
}
