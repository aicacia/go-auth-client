...
//  @return User
func (a *RegisterAPIService) RegisterUserExecute(r ApiRegisterUserRequest) (*User, *http.Response, error) {
	var (
	...
	if r.registerUser == nil {
		return localVarReturnValue, nil, reportError("registerUser is required and must be specified")
	}
